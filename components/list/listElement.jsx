...
const ListElement = ({ data, description, value, index, error, errorMessage, warning, warningMessage }) => {
    return (
        <div
        ...
        >
            <div className={`left lg:w-1/6 font-semibold flex items-center`}>{description}</div>
            <div
