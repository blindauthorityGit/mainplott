...
const GeneralCheckBoxSmall = ({
    ...
    return (
        ...
        >
            {/* Checkbox Container */}
            <motion.div
                className={`relative w-4 h-4 rounded-[4px] border ${borderColor} flex items-center justify-center 
            ...
            >
                ...
                {isChecked && (
                    ...
                    >
                        <MdCheck size={14} className={`${checkColor}`} />
                    </motion.div>
                )}
...
export default GeneralCheckBoxSmall;
